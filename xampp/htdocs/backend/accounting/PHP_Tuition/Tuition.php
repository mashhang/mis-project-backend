    ...
    <div class="modal-content">
        ...
        <form id="tuitionForm">
            ...
            <div class="form-group">
                ...
                <input type="number" id="downpaymentAmount" name="downpayment_amount" required>
            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    const tuitionType = document.getElementById('tuitionType');
    ...
    tuitionType.addEventListener('change', () => {
        if (tuitionType.value === 'Full Payment') {
            const total = parseFloat(tuitionAmount.value) || 0;
            downpaymentAmount.value = total.toFixed(2);
            downpaymentAmount.readOnly = true;
        } else if (tuitionType.value === 'Installment') {
            downpaymentAmount.value = '';
            downpaymentAmount.readOnly = false;
        } else {
            downpaymentAmount.value = '';
            downpaymentAmount.readOnly = false;
        }
    ...
    // Optional: Update downpayment if tuition amount changes while in "Full Payment" mode
